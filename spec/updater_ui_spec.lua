...
package.preload["one_reader.download_dialog"] = function()
    return { new = function(_, value) return value end }
end
package.preload["one_reader.i18n"] = function()
...
local core = {
    ...
    available_version = function() return "0.6.0" end,
}
...
expect(ui:available_version() == "0.6.0",
